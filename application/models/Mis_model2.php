...
<th colspan="3"><center>Day Peak('. $data['day_start'].':00'.'-'.$data['day_end'].':00'.')</center></th>
<th colspan="3"><center>Night Peak('. $data['night_start'].':00'.'-'.$data['night_end'].':00'.')</center></th>

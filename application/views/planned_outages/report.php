                            ...
                            <div class="widget-body clearfix">
                                ...
                                <p class="text-muted">All bootstrap element classies</p> -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class=" col-form-label" for="fault"> Choose Fault </label>
                                             <select class="form-control" name="fault_id" id="fault">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <button  class="form-control btn btn-primary btn-rounded" type="submit">Generate Report</button>
                                            </div>
                                        </div>
                                    ...
                                    <div id="report-container" >
                                        <p style="" id="summary_title"><?= $title ?></p>

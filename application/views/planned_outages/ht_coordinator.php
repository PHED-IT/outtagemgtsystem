              ...
              <div class="card">
                <div class="card-header">
                  <h4>HT Coordinator(Planned Outage)</h4>
                </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer" id="d<?= $outage->outage_id ?>">
             <?php
                if ($outage->status==2) {
              ?>
            <button  id="<?= $outage->outage_id ?>" class="btn btn-sm btn-outline-success acknowled_plan_out_ht_coordinator btn btn-primary btn-sm" data-toggle="tooltip" data-placement="bottom"

...
<footer class="footer"><span class="heading-font-family">Copyright @ 2017. All rights reserved PHED</span>
    </footer>
    </div>
    <!--/ #wrapper -->
    <!-- Scripts -->
   ...
   <!--  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-sparklines/2.1.2/jquery.sparkline.min.js"></script> -->
    ...
    <script src="<?php echo asset_url();?>vendors/theme-widgets/widgets.js"></script>

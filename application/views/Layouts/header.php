    ...
    <div id="wrapper" class="wrapper">
        ...
        <nav class="navbar">
            ...
            <div class="navbar-header">
                <a href="/" style="font-weight: bold;font-size: 25px" class="navbar-brand">
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle dropdown-toggle-user ripple" data-toggle="dropdown"><span class="avatar thumb-xs2"><img src="<?php echo asset_url();?>demo/user.png" class="rounded-circle" alt=""> <i class="feather feather-chevron-down list-icon"></i></span></a>
                    <div

            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Closure By Network System Operations</h6>
                ...
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Closure By Network System Operations</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
...
<div id="nm<?= $tripping->tripping_id ?>" role="dialog" class="modal fade"  >
 ...
 <td>
   ...
   <button onclick="handleClosure(<?= $tripping->tripping_id; ?>);" class="btn btn-sm  btn-outline-primary">Action</button>  
 </td>
...
<div class="form-group">
<label for="serial_number">Work Order Form Serial Number</label>
<input id="serial_number" required name="serial_number" class="form-control"/>
</div>
...
<!-- /.widget-body -->
            ...
            function handleClosure(id){
              ...
              form.action='<?= base_url('tripping/closure_nso_post') ?>/'+id;

                ...
                title="View BOQ"><span class="fa fa-eye text-primary"></span></button>
                  ...
                  <td>
                    <?php
                      if ($outage->status==4) {
                        ?>
                         <button id="<?= $outage->outage_id ?>" class="btn-info acknowle_boq_agm" data-toggle="tooltip" data-placement="bottom"
                title="Acknowledge BOQ"><span class="fa fa-flash"></span></button>
                        <?php
                      }
                    ?>
                  </td>                    

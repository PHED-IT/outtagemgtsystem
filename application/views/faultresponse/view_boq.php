        ...
        <table cellpadding="0" cellspacing="0">
        	...
        	<table id="container_div" class="table table-bordered">
                <thead>
                    ...
                    <th><?= $outage->status>=6?'Available Qty':'Available Qty' ?></th>
                </thead>
        <tbody>
            <?php
                ...
                foreach ($boqs as $key => $boq) {
                    ...
                    <tr>
                        ...
                        <td><?= $boq->quantity ?></td>
                        <td><?= $boq->cost ?></td>
                        <td><?= $boq->cost*(!empty($boq->aval_quantity)?$boq->quantity:$boq->quantity).'00' ?></td>
                            ...
                            if ($outage->status>=6) {
                             if ($boq->available) {
                                   ...
                                   <?php
                                    ...
                                    ?>
                                    <span class="fa fa-ban text-danger" title="Not available" ></span>
                                    <?php
                                }

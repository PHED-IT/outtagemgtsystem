            ...
            <?php echo validation_errors('<div class="alert alert-danger mb-2">','</div>'); ?>
                          ...
                          <form id="transmissionFaultEntry" action="" method="POST">
                            <div class="card">
                              <div class="card-header">
                                <h4>Transmission Fault Entry</h4>
                              </div>
                              <div class="card-body">
           ...
           <!--    <div class="col-md-5"> 
             ...
             <input type="text" name="location" required class="form-control">
              ...
              <textarea required name="remarks" class="form-control" style="color: #333" type="text" value="<?= isset($tripping) ? $tripping->remark:set_value('remarks'); ?>">

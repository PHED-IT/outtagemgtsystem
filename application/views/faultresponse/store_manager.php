                   ...
                   <td>
                    <?php
                      if ($outage->status==5) {
                        ?>
                         <a 
  href="<?= base_url('FaultResponse/approve_material/'.$outage->outage_id) ?>" data-toggle="tooltip" data-placement="bottom"
                title="Appprove Materials" class="btn btn-success"><span class="fa fa-flash"></span></a>
                        <?php
                      }
                    ?>
                  </td>                    

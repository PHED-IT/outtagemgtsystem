...
<body>
    <div class="invoice-box">
        ...
        <form id="boq_form">
            ...
            <div id="container_div">
                <h6 class="my-2">Choose Materials from list</h6>
        <select class="form-control multiple-selector" id="tags" name="item[]" multiple>
            <?php
                foreach ($materials as $key => $value) {
                    ?>
                    <option 
                    <?= (isset($boq) && $boq->item==$value->id)?'selected':'' ?>
    ...
    <div class="my-3">
        <textarea class="form-control" name="remark" placeholder="Enter remark"><?= isset($boq)?$material->remark:'' ?></textarea>
    </div>
        <button type="submit" class="btn  btn-outline-success my-3"><?= isset($boq)?'Edit':'Submit' ?></button>
    </form>
</div>

              ...
              <div class="card">
                <div class="card-header">
                  <h4>Central Dispatch Fault/Rapid Response</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                       <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <!-- 33kv feeder -->
                 <table id="simpleTable_fualt" class="table tables  table-bordered table-responsive" data-toggle="datatables" data-plugin-options='{"searching": true}'>
                     <thead>
                      <tr>
                       <th> Id</th>
                      <th>Equipment</th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
             ...
             <?php
              ...
              <?php
               if ($outage->status==1 && $outage->voltage_level=="33kv") {
            ?>
            <input type="hidden" name="outage_id" value="<?= $outage->outage_id ?>">

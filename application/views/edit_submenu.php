                            ...
                            <div class="widget-body clearfix">
                                ...
                                <form action="" method="POST">
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="role_id"> Menu</label>
                                        <div class="col-md-9">
                                            <select class="form-control" name="menu_id" id="role">
                                                <option value="<?= $data_menu->id ?>"><?= $data_menu->name_alias ?></option>
                                     ...
                                     <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="menu">Sub Menu</label>
                                        <div class="col-md-9">
                                            <select class="form-control" name="sub_menu_id" id="menu">
                                                <?php
                                                    foreach ($sub_menus as $key => $menu) {
                                                        ...
                                                        value="<?= $menu->id ?>"
                                                        <?php
                                                            if (isset($data_sub_menu)) {
                                                               if ($menu->id==$data_sub_menu->id) {
                                                                   echo ' selected';
                                                               }
                                                            }
                                                        ?>
                                        ...
                                        <?php echo form_error('sub_menu_id','<span style="color:red">','</span>'); ?>
                                    </div>

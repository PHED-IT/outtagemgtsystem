               ...
               <div class="card">
                               <div class="card-header"><h4>POWER FACTOR REPORT</h4></div>
                               <div class="card-body">
            ...
            <div id="avgChart"></div>
                                    ...
                                    <div id="report-container" >
                                        ...
                                        ?>
                                         <h6>
                                            <strong>
                                            <span class="text-info">Avg:</span><?= (isset($average))?$average->pf:"0" ?> | 
                                            <span class="text-info">Min. Power Factor: </span><?= $min->pf;?><?= ($dt=="month")? " <span class='text-info'> Day: </span> ".date("d/m/Y",strtotime($min->captured_at)):" <span class='text-info'>Hour:</span> ".$min->hour ?>  |
                                            <span class="text-info">Max. Power Factor: </span><?= $max->pf;?><?= ($dt=="month")? " <span class='text-info'> Day: </span> ".date("d/m/Y",strtotime($max->captured_at)):" <span class='text-info'>Hour:</span> ".$max->hour ?> 
                                            </strong>
                                        </h6>
                                        <?php } ?>

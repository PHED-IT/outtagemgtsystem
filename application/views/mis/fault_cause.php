<div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Fault by Cause Report</h6>
                ...
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Fault by Cause Report</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <span id="spinner"></span>
                                             <!-- <select class="form-control" name="asset_name" id="asset_select">
                                                ...
                                                <input required type="text" placeholder="Search " value="<?= isset($tripping) ? $tripping->asset_name:set_value('asset_name'); ?>" name="asset_name" class="form-control asset_name">
                                            </div>
                                        </div>

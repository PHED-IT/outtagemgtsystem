  ...
  var Unifato = {
    ...
    sidebar: function() {
      ...
      $('.side-menu').on('show.metisMenu',function() {
        var $siteSidebarWithScrollbar = $('.site-sidebar.scrollbar-enabled');
        if($siteSidebarWithScrollbar) return;
        $siteSidebarWithScrollbar.perfectScrollbar('destroy');
        self.initScrollbar( $siteSidebarWithScrollbar[0] );
      });
      this.sidebarToggle();
  ...
  //     });
    ...
    enableSparkline: function() {
      ...
      el.each(function() {
        ...
        var defaults = { enableTagOptions: true };
        var data = $.extend(data, defaults, {});
        for(var att in data) {
          if( data[att] === "undefined" ) data[att] = undefined;
        }
        console.log( data );
